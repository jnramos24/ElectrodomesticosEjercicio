package workshop.ejecutable;

import workshop.Entidades.Electrodomestico;
import workshop.Entidades.Lavadora;
import workshop.Entidades.Televisor;
...
class UtilidadesMain {
    ...
    public static Electrodomestico[] crearLista() {
        ...
        lista[0] = new Electrodomestico();      //Elementos creados con contructores vacios
        lista[1] = new Lavadora();              //Elementos creados con contructores vacios
        lista[2] = new Televisor();             //Elementos creados con contructores vacios
        lista[3] = new Electrodomestico(190, 80); // Constructor con dos parametros
        lista[4] = new Lavadora(190, 80);          // Constructor con dos parametros
        lista[5] = new Televisor(190, 80);          // Constructor con dos parametros
